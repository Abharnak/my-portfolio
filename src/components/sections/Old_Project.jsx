        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Abharnak/Data-Visualization-projects/blob/main/Investor-Trend-Analysis/README.md"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
            ...
            "
            >
              <h3 className="text-xl font-bold mb-2">Healthcare Claim Cost Analysis</h3>
              <p className="text-gray-400 mb-4">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {["SQL","Powerbi", "Excel"].map((tech, key) => (
                  <span
                    key={key}
                    className="
                      bg-blue-500/10 text-blue-500 py-1 px-3 
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Abharnak/Data-Visualization-projects/blob/main/Healthcare-Claims-Cost-Analysis/README.md"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
            ...
            "
            >
              <h3 className="text-xl font-bold mb-2">Superstore Sales Analysis</h3>
              <p className="text-gray-400 mb-4">
              This project analyzes sales performance from the Superstore dataset and provides an interactive dashboard to uncover insights into profits, sales, and customer segments. The dashboard helps businesses track regional performance, product categories, and customer trends for better decision-making.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["SQL","Powerbi", "Excel"].map((tech, key) => (
                  <span
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Abharnak/Data-Visualization-projects/blob/main/Superstore-Sales-Analysis/README.md"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
